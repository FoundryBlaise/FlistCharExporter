# F-list Character Exporter (legacy userscript)

> **Heads up.** The browser extension at the root of this repo
> ([README.md](README.md)) is now the primary restore tool. This
> userscript remains supported as a hot-fix path when F-list breaks
> form selectors and the extension's release queue is slow.

A userscript to export and import F-list character profiles as ZIP
